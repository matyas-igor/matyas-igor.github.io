...
if (ENVIRONMENT == 'testing') {
    sendEmails($testingEmails, 'test@misterq.ru', 'Test editor', 'Test editor', $files);
    exit();
}
...
//        var_dump($collections); exit();
    ...
    <variants-attributes type="array">
        ...
        $product = $insales_api('POST', '/admin/products.xml', $productXml, 'xml');
...
<collect>
    ...
    $response = $insales_api('POST', '/admin/collects.xml', $productCollectionXml, 'xml');

//    $response = $insales_api('GET', '/admin/products/#'.$productId.'/images.json');
//
//    var_dump($response);
//    exit();
    ...
    <attachment><![CDATA['.$files['product']['image'].']]></attachment>
        ...
        $response = $insales_api('POST', '/admin/products/'.$productId.'/images.xml', $productImageXml, 'xml');
...
//    var_dump($productImageXml);
    ...
    <attachment><![CDATA['.$files['wallpaper']['image'].']]></attachment>
        ...
        $response = $insales_api('POST', '/admin/files.xml', $productWallpaperXml, 'xml');
...
//    var_dump($response);
    ...
    <title>'.$productName.' №'.$productId.'</title>
        ...
        $response = $insales_api('PUT', '/admin/products/'.$productId.'.xml', $productNameXml, 'xml');
  ...
  <value>'.$productWallpaperUrl.'</value>
        ...
        $response = $insales_api('POST', '/admin/products/'.$productId.'/product_field_values.xml', $productFieldXml, 'xml');
